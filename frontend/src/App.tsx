...
useEffect(() => {
  ...
  const updateGPSMap = ({latitude, longitude}) => {  
      ...
      const ctx = canvas.getContext('2d');
        ...
        ctx.fillStyle = 'white';
        ctx.font = '14px Arial';
        ctx.fillText(`X: ${longitude.toFixed(2)}, Y: ${latitude.toFixed(2)}`, 10, 20)
  }
      ...
      <div className="dashboard">
        ...
        <div className="current-data">
          ...
          <div className="data-item">
            ...
            <span>{altitude} {altitudeUnit}</span>
          </div>
          <div className="data-item">
            <span className="label">GPS Coordinates:</span>
            <span>Lat: {gpsCoordinates.latitude}, Lon: {gpsCoordinates.longitude}</span>
          </div>
          <div className="data-item">
